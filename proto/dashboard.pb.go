...
var file_dashboard_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06,
...
var file_dashboard_proto_goTypes = []interface{}{
	(*GetDataRequest)(nil),  // 0: dashboard.GetDataRequest
	(*GetDataResponse)(nil), // 1: dashboard.GetDataResponse
}
var file_dashboard_proto_depIdxs = []int32{
	0, // 0: dashboard.DashboardService.GetData:input_type -> dashboard.GetDataRequest
	1, // 1: dashboard.DashboardService.GetData:output_type -> dashboard.GetDataResponse
...
func (c *dashboardServiceClient) GetData(ctx context.Context, in *GetDataRequest, opts ...grpc.CallOption) (*GetDataResponse, error) {
	out := new(GetDataResponse)
	err := c.cc.Invoke(ctx, "/dashboard.DashboardService/GetData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedDashboardServiceServer) GetData(context.Context, *GetDataRequest) (*GetDataResponse, error) {
...
func _DashboardService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DashboardServiceServer).GetData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dashboard.DashboardService/GetData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DashboardServiceServer).GetData(ctx, req.(*GetDataRequest))
	}
...
var _DashboardService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetData",
			Handler:    _DashboardService_GetData_Handler,
		},
	},
